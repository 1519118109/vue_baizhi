        ...
        <div class="main">
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <p class="data">{{course.students}}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：{{course.pub_lessons}}课时/{{course.lessons}}小时&nbsp;&nbsp;&nbsp;&nbsp;难度：{{course.level_name}}</p>
                    <div class="sale-time">
                        <p class="sale-type" v-if="course.discount_name">{{course.discount_name}}</p>
                        <p class="expire" v-if="course.discount_name">距离结束：仅剩{{course.rest_time[0]}} 天 {{course.rest_time[1]}}小时 {{course.rest_time[2]}}分 <span class="second">{{course.rest_time[3]}}</span> 秒</p>
                    </div>
                    <p class="course-price">
                        <span>活动价</span>
                        <span class="discount" v-if="course.discount_name">¥{{course.real_price}}</span>
                        <span class="discount" v-else>¥{{course.price}}</span>
                ...
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        <div class="tab-item-title">
                            ...
                            <p class="chapter-length">共{{chapter_list.length}}章 {{course.pub_lessons}}个课时</p>
                        </div>
                        <div class="chapter-item" v-for="(chapter,index) in chapter_list" :key="index">
                            ...
                            <ul class="lesson-list" v-for="(lesson, index) in chapter.coursesections" :key="index">
                                <li class="lesson-item">
                                    <p class="name"><span class="index">1-1</span> {{lesson.name}}<span class="free" v-if="lesson.free_trail">免费</span>
                                    </p>
    ...
    export default {
        ...
        add_cart(course_id) {
            ...
            this.$axios.post(this.$settings.HOST+"cart/option/", {
                ...
                // 向状态机提交动作来修改购物车商品的总数
                // console.log(response.data.cart_length);
