        ...
        <div class="header">
            <div class="content">
                ...
                <ul class="nav full-left">
                    <li v-for="(nav, index) in header_list" :key="index">
                        <!--                项目外的连接        -->
                ...
                <div class="login-bar full-right" v-if="token">
                    ...
                    <div class="shop-cart full-left">
                        ...
                        <span v-if="this.$store.state.cart_length"><router-link to="/cart">{{this.$store.state.cart_length}}购物车</router-link></span>
                        <span v-else><router-link to="/cart">{{cart_num}}购物车</router-link></span>
                    </div>
